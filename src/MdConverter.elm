...
renderea : Result String (List Block) -> List (Html msg)
renderea resultado =
    let
        resultadoProcesado : Result String (List (Html msg))
        resultadoProcesado =
            resultado
                |> Result.andThen
...
procesaHtml : Markdown.Html.Renderer (List (Html msg) -> Html msg)
procesaHtml =
    let
        showDiv : Maybe String -> Maybe String -> List (Html msg) -> Html msg
        ...
        showSpan : String -> List (Html msg) -> Html msg
